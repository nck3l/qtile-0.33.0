  Simple-ish qtile configs that appear to have 3 pill-shaped bars that can float by uncommenting the margins as the bottom of the "Screen" definition, Scratchpads (terminal and an ncmpcpp player), and color themes stolen directly from DistroTube (https://gitlab.com/dwt1/dotfiles/-/tree/master/.config/qtile?ref_type=heads).
  They require Nerd Fonts (https://www.nerdfonts.com/#home).
